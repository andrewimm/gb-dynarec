...
pub fn decode(instructions: &[u8]) -> (Op, usize, usize) {
  match instructions[0] {
    ...
    0xb8 => (Op::Compare8(Register8::B), 1, 4),
    0xb9 => (Op::Compare8(Register8::C), 1, 4),
    0xba => (Op::Compare8(Register8::D), 1, 4),
    0xbb => (Op::Compare8(Register8::E), 1, 4),
    0xbc => (Op::Compare8(Register8::H), 1, 4),
    0xbd => (Op::Compare8(Register8::L), 1, 4),
    0xbe => (Op::CompareIndirect, 1, 8),
    0xbf => (Op::Compare8(Register8::A), 1, 4),
